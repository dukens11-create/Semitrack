...
const messages: Record<string, string> = {
  ...
  TRUCK_CREATE_OPERATION_CONFLICT: 'This create attempt already used different values. Reload your profiles and review the saved result before creating another.',
  TRUCK_CREATE_RESULT_REMOVED: 'The profile from this create attempt was removed. Reload your profiles before starting a new profile.',
  TRIMBLE_STOP_COVERAGE_UNPROVEN: 'The routing provider could not confirm every requested stop in order. No new route was accepted.',
