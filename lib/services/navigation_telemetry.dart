...
class NavigationTelemetry {
  ...
  static const _blockedExact = <String>{'lat', 'lng', 'latitude', 'longitude'};
  ...
  void record(String name, Map<String, Object?> fields) {
    ...
    for (final entry in fields.entries) {
      ...
      if (value == null || value is num || value is bool || value is String && value.length <= 256) {
  ...
  bool _isBlocked(String key) {
    ...
    if (_blockedExact.contains(normalized)) return true;
