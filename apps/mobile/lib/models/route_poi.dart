...
enum PoiType {
  ...
  /// International or state border port of entry for commercial vehicles.
  portOfEntry,

  /// Commercial vehicle inspection site.
  inspectionSite,
}
...
const List<RoutePoi> mockRoutePois = [
  ...
  RoutePoi(
    id: 'poe_1',
    name: 'California/Oregon Border Port',
    type: PoiType.portOfEntry,
    position: LatLng(41.994, -122.661),
    subtitle: 'CA/OR Border, US-97',
    status: PoiStatus.open,
  ),
  RoutePoi(
    id: 'poe_2',
    name: 'Nevada/California Border Port',
    type: PoiType.portOfEntry,
    position: LatLng(38.996, -119.940),
    subtitle: 'CA/NV Border, US-395',
    status: PoiStatus.open,
  ),
  ...
  RoutePoi(
    id: 'is_1',
    name: 'I-5 Inspection Site',
    type: PoiType.inspectionSite,
    position: LatLng(43.580, -122.920),
    subtitle: 'I-5, OR',
