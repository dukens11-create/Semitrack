# LEGACY / REFERENCE ONLY — NOT PRODUCTION CLIENT

Archived root setup instructions. These commands do not build the production SemiTraX client. Firebase placeholders and historic APK publishing instructions below are not current deployment requirements. Use ../../apps/mobile-react-native/README.md for the production client.
