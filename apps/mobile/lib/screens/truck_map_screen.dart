...
class _TruckMapScreenState extends State<TruckMapScreen> {
  ...
  static final List<TruckStop> _mockTruckStops = [
    ...
    TruckStop(
      ...
      description: 'Esso with diesel, DEF, convenience store, and truck-friendly canopy.',
    ),
    TruckStop(
      id: '27',
      name: 'Petro-Canada Truck Stop',
      brand: 'Petro-Canada',
      position: const LatLng(49.246, -123.116),
      address: 'Vancouver, BC',
      dieselPrice: 4.60,
      icon: 'petrocanada',
      assetLogo: 'assets/logos/petro-canada.png',
      description: 'Petro-Canada with diesel, DEF, showers, and Subway restaurant on-site.',
    ),
    TruckStop(
      id: '28',
      name: 'Walmart Supercenter',
      brand: 'Walmart',
      position: const LatLng(36.362, -94.208),
      address: 'Bentonville, AR',
      icon: 'walmart',
      assetLogo: 'assets/logos/walmart.png',
      description: 'Walmart Supercenter with overnight truck parking and full shopping facilities.',
    ),
    TruckStop(
      id: '29',
      name: 'Truck Stop Hotel',
      brand: 'Hotel',
      position: const LatLng(36.746, -119.772),
      address: 'Fresno, CA',
      icon: 'hotel',
      assetLogo: 'assets/logos/hotel.png',
      description: 'Trucker-friendly hotel with large vehicle parking, showers, and rest facilities.',
    ),
    TruckStop(
      id: '30',
      name: 'Truck Stop Gym',
      ...
      description: 'Fitness center open to truckers 24/7 with showers and locker rooms.',
    ),
    TruckStop(
      id: '31',
      name: 'Truck Stop Restaurant',
      brand: 'Restaurant',
      position: const LatLng(32.755, -97.330),
      address: 'Fort Worth, TX',
      icon: 'restaurant',
      assetLogo: 'assets/logos/restaurant .png',
      description: 'Full-service restaurant with home-cooked meals and large vehicle parking.',
    ),
    TruckStop(
      id: '32',
      name: 'Semi Truck Wash',
      brand: 'Truck Wash',
      position: const LatLng(39.103, -84.512),
      address: 'Cincinnati, OH',
      icon: 'truckwash',
      assetLogo: 'assets/logos/semi truck wash.png',
      description: 'Full-service semi truck wash with touchless automated bays and hand detailing.',
    ),
  ];
