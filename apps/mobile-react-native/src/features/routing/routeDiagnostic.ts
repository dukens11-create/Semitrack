...
const codes = {
  ...
  ROUTE_APP_NOT_ACTIVE: 'LOCAL_APP_STATE',
  GPS_PERMISSION_REQUIRED: 'LOCAL_LOCATION',
  GPS_UNAVAILABLE: 'LOCAL_LOCATION',
  GPS_ACQUISITION_TIMEOUT: 'LOCAL_LOCATION',
  FRESH_LOCATION_REQUIRED: 'LOCAL_LOCATION',
